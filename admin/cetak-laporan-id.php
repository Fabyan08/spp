                                                    ...
                                                    <td class="content-block">
                                                        <table class="invoice">
                                                            <tbody>
                                                                <tr>
                                                                    <td> Nama: <?= $data['nama']; ?>
                                                                        <br>NISN: <?= $data['nisn']; ?><br>Tanggal: <?= $data['tgl_bayar']; ?><br>Bulan: <?= $data['bulan_bayar']; ?><br>Kelas: <?= $data['nama_kelas']; ?>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>Jumlah Bayar</td>
                                                                                    <td class="alignright"><?= "Rp" . number_format($data['jumlah_bayar'], 0, ',', '.'); ?></td>
                                                                                </tr>
                                                                                <tr class="total">
